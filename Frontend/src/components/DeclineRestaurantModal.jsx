...
function DeclineRestaurantModal({ setDeclineRestaurantModal, restaurant, fetchRestaurants }) {

    const handleDeclineClick = async () => {
        const decision = "declined";
        try {
            await axios.post(`http://localhost:3000/api/admin/restaurant/${restaurant.id}`, { decision });
            setDeclineRestaurantModal(false)
            fetchRestaurants();
        } catch (error) {
            console.error(error);
        }
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="p-4 md:p-5 text-center">
                        ...
                        <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                            Are you sure you want to decline this Restaurant?
                        </h3>
                        <button
                            data-modal-hide="popup-modal"
                            type="button"
